...
export const FEED_CACHE_TTL_MS = 1000 * 60 * 120; // 120 minutes - extended for reduced server load
export const FEED_FAIL_TTL_MS = 1000 * 60 * 10; // 10 minutes negative cache for failing feeds
