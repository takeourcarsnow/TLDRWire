...
export default function NewsFormSelectors({ preferences, onPreferenceChange, selectedPreset }: Props) {
    ...
    <>
      <div className="form-group regions-group">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
          ...
          <PresetCarousel options={REGION_OPTIONS} value={preferences.region} onChange={(v) => onPreferenceChange('region', v)} selectedPreset={selectedPreset} onMouseEnter={() => { setShowRegionLabel(true); setShowLanguageLabel(false); setShowCategoryLabel(false); setShowStyleLabel(false); }} onMouseLeave={() => setShowRegionLabel(false)} />
        </div>
      </div>
      ...
      <div className="form-group language-group">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', flex: 1 }}>
          ...
          <PresetCarousel options={LANGUAGE_OPTIONS} value={preferences.language} onChange={(v) => onPreferenceChange('language', v)} selectedPreset={selectedPreset} onMouseEnter={() => { setShowLanguageLabel(true); setShowRegionLabel(false); setShowCategoryLabel(false); setShowStyleLabel(false); }} onMouseLeave={() => setShowLanguageLabel(false)} />
        </div>
      </div>
      ...
      <div className="form-group category-group">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', flex: 1 }}>
          ...
          <PresetCarousel options={CATEGORY_OPTIONS} value={preferences.category} onChange={(v) => onPreferenceChange('category', v)} selectedPreset={selectedPreset} onMouseEnter={() => { setShowCategoryLabel(true); setShowRegionLabel(false); setShowLanguageLabel(false); setShowStyleLabel(false); }} onMouseLeave={() => setShowCategoryLabel(false)} />
        </div>
      </div>
      ...
      <div className="form-group">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', flex: 1 }}>
          ...
          <PresetCarousel options={STYLE_OPTIONS} value={preferences.style} onChange={(v) => onPreferenceChange('style', v)} selectedPreset={selectedPreset} onMouseEnter={() => { setShowStyleLabel(true); setShowRegionLabel(false); setShowLanguageLabel(false); setShowCategoryLabel(false); }} onMouseLeave={() => setShowStyleLabel(false)} />
        </div>
      </div>
    </>
  );
